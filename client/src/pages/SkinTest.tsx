  ...
  const handleProductClick = (product: any) => {
    ...
    if (product.id === "serum" && serumIngredients) {
      ...
      setSelectedProduct({
        ...
        image: "https://herbsomweb-rcxwgckf.manus.space/manus-storage/hf_20260617_081131_6c43fbf2-5ff1-4e70-b1e5-84a04df359ae_99d10a88.png",
    ...
    if (product.id === "creme" && cremeIngredients) {
      ...
      setSelectedProduct({
        ...
        image: "https://herbsomweb-rcxwgckf.manus.space/manus-storage/hf_20260617_073341_a333548e-590d-40be-85dc-8fab622efb62(1)_b174e817.png",
