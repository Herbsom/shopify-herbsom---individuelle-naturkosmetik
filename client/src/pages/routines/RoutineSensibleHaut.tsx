...
import { ROUTINE_SENSIBLE_HAUT } from "@/lib/routineRecommendations";
...
export default function RoutineReifHaut() {
  ...
  const rec = ROUTINE_SENSIBLE_HAUT;
        ...
        <section className="relative h-96 md:h-[600px] bg-[#F8F5F0] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-4 max-w-3xl">
            ...
            <p className="font-body text-base md:text-lg leading-relaxed text-[#4A4A48]">
              Eine Routine individuell auf sensible Haut zugeschnitten – für Beruhigung und Schutz
            </p>
          </div>
        </section>
        ...
        <section className="py-16 md:py-24 lg:py-32 bg-[#5B5B38]">
          <div className="container max-w-7xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              {[
                { icon: "✓", title: "Sanfte & beruhigende Pflege", text: "mit hautfreundlichen Wirkstoffen" },
                { icon: "✓", title: "Reduziert Rötungen", text: "und stärkt die Hautbarriere" },
                { icon: "✓", title: "Sichtbare Ergebnisse", text: "bereits nach 2–4 Wochen" },
              ].map((item, idx) => (
                <div key={idx}>
        ...
        <section className="py-16 md:py-24">
          <div className="container max-w-5xl">
            ...
            <p className="font-body text-center text-[#7D7D5D] mb-16">
              Fünf Schritte für sanfte Pflege und Hautbarrieren-Schutz
            </p>
...
{product.href?.startsWith("/configurator") && (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
              <div>
                ...
                <div className="space-y-8 lg:space-y-10">
                  {[
                    { step: "1", title: "Morgens & Abends: Reinigen", desc: "Reinige dein Gesicht mit der sanften Reinigungsmilch, um Unreinheiten zu entfernen ohne zu reizen." },
                    { step: "2", title: "1x pro Woche: Peeling", desc: "Trage das AHA & PHA Peeling einmal pro Woche auf für sanfte Exfoliation." },
                    { step: "3", title: "Morgens & Abends: Serum", desc: "Dein individuelles Serum mit Panthenol & Centella beruhigt und stärkt die Hautbarriere." },
                    { step: "4", title: "Abends: Creme", desc: "Deine individuelle Creme mit Ceramiden & Hyaluron regeneriert die Haut über Nacht." },
                    { step: "5", title: "Morgens: Sonnenschutz", desc: "Das Sonnenschutzfluid schützt vor UV-Strahlung ohne Reizstoffe." },
                  ].map((item) => (
        ...
        <section className="py-16 md:py-24">
          <div className="container max-w-7xl">
            ...
            <p className="font-body text-center text-[#7D7D5D] mb-16">Echte Erfahrungen von Menschen mit reifer Haut</p>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                {
                  text: "Endlich eine Routine, die meine reife Haut wirklich verjüngt! Die Falten sind sichtbar weniger geworden.",
                  author: "Petra M.",
                  location: "München",
                },
                {
                  text: "Die Wirkstoffe sind hochkonzentriert und wirken! Meine Haut strahlt wieder wie früher.",
                  author: "Claudia K.",
                  location: "Berlin",
                },
                {
                  text: "Perfekt für reife Haut! Keine Irritationen, nur Straffung und jugendliche Ausstrahlung.",
                  author: "Sabine L.",
                  location: "Hamburg",
                },
              ].map((testimonial, index) => (
                <div key={index} className="bg-[#F8F5F0] p-8 rounded-lg border border-[#E5E0D8]">
                  <div className="flex gap-1 mb-4">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} size={16} className="fill-[#5B5B38] text-[#5B5B38]" />
                    ))}
                  </div>
                  <p className="font-body text-sm text-[#4A4A48] mb-6 leading-relaxed">"{testimonial.text}"</p>
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-[#5B5B38] rounded-full flex items-center justify-center group">
                      <span className="font-display text-sm text-[#F8F5F0] font-light">{testimonial.author[0]}</span>
                    </div>
                    <div>
                      <p className="font-display text-sm text-[#1C1C1A] font-light">{testimonial.author}</p>
        ...
        <section className="py-16 md:py-24 lg:py-32 bg-[#5B5B38]">
          <div className="container max-w-7xl text-center">
            <h2 className="font-display text-4xl md:text-5xl text-[#F8F5F0] mb-6 font-light">
              Unsicher, welche Routine passt zu dir?
            </h2>
            <p className="font-body text-lg text-[#E8E3DB] mb-8">
              Mache unseren Hauttest und finde deine perfekte Routine
            </p>
            <Link
              href="/hauttest"
