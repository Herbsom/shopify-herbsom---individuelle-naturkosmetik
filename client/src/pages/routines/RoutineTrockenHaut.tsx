...
import { ROUTINE_TROCKENE_HAUT } from "@/lib/routineRecommendations";
...
export default function RoutineReifHaut() {
  ...
  const rec = ROUTINE_TROCKENE_HAUT;
        ...
        <section className="relative h-96 md:h-[600px] bg-[#F8F5F0] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-4 max-w-3xl">
            ...
            <p className="font-body text-base md:text-lg leading-relaxed text-[#4A4A48]">
              Eine Routine individuell auf trockene Haut zugeschnitten – für tiefe Feuchtigkeitspflege
            </p>
          </div>
        </section>
        ...
        <section className="py-16 md:py-24 lg:py-32 bg-[#5B5B38]">
          <div className="container max-w-7xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              {[
                { icon: "✓", title: "Intensive Feuchtigkeitspflege", text: "mit hochkonzentrierten Hyaluronsäuren" },
                { icon: "✓", title: "Stärkt die Hautbarriere", text: "und reduziert Trockenheit" },
        ...
        <section className="py-16 md:py-24">
          <div className="container max-w-5xl">
            ...
            <p className="font-body text-center text-[#7D7D5D] mb-16">
              Fünf Schritte für intensive Feuchtigkeitspflege und Regeneration
            </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
              <div>
                ...
                <div className="space-y-8 lg:space-y-10">
                  {[
                    { step: "1", title: "Morgens & Abends: Reinigen", desc: "Reinige dein Gesicht mit der sanften Reinigungsmilch, um Make-up zu entfernen ohne auszutrocknen." },
                    { step: "2", title: "2x pro Woche: Peeling", desc: "Trage das AHA & PHA Peeling zweimal pro Woche auf, um abgestorbene Hautzellen sanft zu entfernen." },
                    { step: "3", title: "Morgens & Abends: Serum", desc: "Dein individuelles Serum mit Hyaluronsäure & Ceramiden spendet intensive Feuchtigkeit." },
                    { step: "4", title: "Abends: Creme", desc: "Deine individuelle Creme mit Hyaluron & Pflanzenölen regeneriert die Haut über Nacht." },
